        ...
        <div className="d-flex justify-content-center"> 
            <form className="container" onSubmit={handleSubmit(manejarSubmit)}>  
                    <div style={{width: '600px', marginTop: '3rem', marginBottom: '0.5rem'}}>
                        ...
                        <div className="card-body pb-0">
                                ...
                                <div className="form-group">
                                    ...
                                    <select name="tipoDocReceptor" className="form-control" 
                                        ...
                                        {
                                            tipoDOC.map((elm,i) => (
                                                <option key={i} value={elm.tipodocCod}>{elm.tipodocCod}-{elm.tipodocDesc}</option>
                                            ))
                                        }
                                    </select>
                                    {
                                ...
                                <div className="form-group">
                                    <label htmlFor="totalCpe">Importe Total del Comprobante:</label>
                                    <div className="input-group">
                        ...
                        <button type="submit" className="btn btn-secondary btn-block mb-1 colorjadal">Consultar</button>
